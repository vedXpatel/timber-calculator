...
import {View, StyleSheet, Dimensions, TextInput, ScrollView, Text, Button} from 'react-native';
                ...
                (<View>
                    <DataTable style={{ position: 'relative', left: -width / 5, width: width + width / 5, }} >
                        <DataTable.Header style={{ borderBottomWidth: 1, borderBottomColor: 'black', borderColor: 'black', overflow: 'hidden' }}>
                            ...
                            <DataTable.Title textStyle={{ fontSize: 17, fontWeight: 'bold', }} numeric>Cubic MTR</DataTable.Title>
                        </DataTable.Header>
                        {list.map((item, index) => (
                            <DataTable.Row key={index}>
                                ...
                                <DataTable.Cell textStyle={{ fontSize: 17, }} numeric>{(item.CMT).toFixed(4)}</DataTable.Cell>
                            </DataTable.Row>
                        ))}
                        <DataTable.Row style={{ borderTopWidth: 1, borderColor: 'black', borderBottomWidth: 0,marginLeft: 20, }}>
